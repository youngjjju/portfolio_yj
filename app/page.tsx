...
export default function Home() {
  ...
  return (
    <>
      <section id="item-1" className="item">
        <div id="first_container">
          ...
          <div className="ml-80 w-full h-full">
            <div className="w-[602px] h-[787px] bg-white shadow-lg rounded-3xl">
              ...
              <Image src="/main.png" width={603} height={801} alt="main" />
      ...
      <section id="item-2" className="item"></section>
      <section id="item-3" className="item"></section>
    </>
  );
}
